...
extension Activity {
    ...
    static let a15 = Activity(id: 15, catID: 3, name: "Battery", multiAdd: true, image: #imageLiteral(resourceName: "recycled-battery"), pts: 3150, kWh: nil, mi: nil, paper: nil, plastic: nil, water: nil)
    static let a16 = Activity(id: 16, catID: 3, name: "Aluminum can", multiAdd: true, image: #imageLiteral(resourceName: "recycled-can"), pts: 3150, kWh: nil, mi: nil, paper: nil, plastic: nil, water: nil)
    static let a17 = Activity(id: 17, catID: 3, name: "Electronic device", multiAdd: true, image: #imageLiteral(resourceName: "recycled-device"), pts: 3150, kWh: nil, mi: nil, paper: nil, plastic: nil, water: nil)
    static let a18 = Activity(id: 18, catID: 3, name: "Cardboard or paper", multiAdd: true, image: #imageLiteral(resourceName: "paper-small"), pts: 3150, kWh: nil, mi: nil, paper: 28, plastic: nil, water: nil)
    static let a19 = Activity(id: 19, catID: 3, name: "Clothing/textiles", multiAdd: true, image: #imageLiteral(resourceName: "recycled-fabric"), pts: 3150, kWh: nil, mi: nil, paper: nil, plastic: nil, water: nil)
    static let a20 = Activity(id: 20, catID: 3, name: "Glass container", multiAdd: true, image: #imageLiteral(resourceName: "recycled-glass"), pts: 3150, kWh: nil, mi: nil, paper: nil, plastic: nil, water: nil)
    static let a21 = Activity(id: 21, catID: 3, name: "Plastic bag", multiAdd: true, image: #imageLiteral(resourceName: "plastic-bag"), pts: 3150, kWh: nil, mi: nil, paper: nil, plastic: 4, water: nil)
