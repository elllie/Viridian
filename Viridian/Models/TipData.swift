...
extension Tip {
    ...
    static let t7 = Tip(content: "E-statements are also faster, more secure, and easier to use overall than paper bills. Some financial institutions also provide a discount for using the service.", activities: [7])
